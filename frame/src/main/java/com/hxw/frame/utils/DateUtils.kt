...
object DateUtils {
    ...
    fun getFriendlyTimeSpan(millis: Long): String {
        ...
        return when {
            ...
            span < TimeConstants.SEC -> return "刚刚"
            span < TimeConstants.MIN -> return String.format("%d秒前", span / TimeConstants.SEC)
            span < TimeConstants.HOUR -> return String.format("%d分钟前", span / TimeConstants.MIN)
            span < TimeConstants.DAY -> return String.format("%d小时前", span / TimeConstants.HOUR)
            else -> return String.format("%d天前", span / TimeConstants.DAY)
        }
    }
