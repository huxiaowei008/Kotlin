...
object RegexConstants {
     ...
     * 正则：车牌
     */
    const val REGEX_LICENSE = "^[京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领A-Z]{1}[A-Z]{1}[A-Z0-9]{4}[A-Z0-9挂学警港澳]{1}$"

    /**
     * 正则：车牌
     */
    const val REGEX_NEWENERGY_LICENSE = "^[京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领A-Z]{1}[A-Z]{1}([DF][A-HJ-NP-Z0-9][0-9]{4}|[0-9]{5}[DF])$"
    ///////////////////////////////////////////////////////////////////////////
